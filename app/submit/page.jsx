          ...
          <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-8 space-y-6">
            ...
            {page === 4 && (
              <>
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">How did you find PatchMySite?</label>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-xs text-slate-600 leading-relaxed">
                      I have read and agree to the <Link href="/terms" className="text-blue-600 underline">PatchMySite Terms of Service</Link>, including the scope policy. I understand that work will pause if my issue exceeds the selected tier, and I will be notified before any additional charges.
                    </span>
                  </label>
                </div>
            ...
            <div className="flex justify-between pt-2">
              ...
              {page < totalPages ? (
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  {loading ? 'Redirecting to payment...' : 'Pay & Submit →'}
                </button>
              )}
            </div>
          </div>
